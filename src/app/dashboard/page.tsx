...
import { Grid } from '@mui/material'; // <-- v1 Grid
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <LatestProducts
          products={[
            { id: 'PRD-005', name: 'Soja & Co. Eucalyptus', image: '/assets/product-5.png', updatedAt: dayjs().subtract(5, 'hour').subtract(18, 'minutes').toDate() },
            { id: 'PRD-004', name: 'Necessaire Body Lotion', image: '/assets/product-4.png', updatedAt: dayjs().subtract(3, 'hour').subtract(41, 'minutes').toDate() },
            { id: 'PRD-003', name: 'Ritual of Sakura', image: '/assets/product-3.png', updatedAt: dayjs().subtract(3, 'hour').subtract(5, 'minutes').toDate() },
            { id: 'PRD-002', name: 'Lancome Rouge', image: '/assets/product-2.png', updatedAt: dayjs().subtract(2, 'hour').subtract(23, 'minutes').toDate() },
            { id: 'PRD-001', name: 'Erbology Aloe Vera', image: '/assets/product-1.png', updatedAt: dayjs().subtract(10, 'minutes').toDate() },
          ]}
          sx={{ height: '100%' }}
        />
      </Grid>
